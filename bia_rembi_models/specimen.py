...
class GrowthProtocol(FreeText):
    ...
    _examples = [
        "Cells were grown in Minimal Essential Medium (MEM) supplemented with 10% fetal bovine serum (FBS) and containing 100 IU/ml penicillin and 100 μg/ml streptomycin at 37 °C. All culture reagents were purchased from Sigma",
        "For tumour xenograft model cells from the FaDu human breast cancer cell line were cultured in complete medium (Dulbecco's minimum essential medium Eagle with L-glutamine (DMEM) (Lonza)+10% fetal bovine serum (Invitrogen)) in the ratio 1:10 (vol/vol) and incubated at 37'C and 5% CO2",
        "An overnight preculture in HC (Hartwell's complete) medium was used to inoculate a 10 ml culture. Cells were then grown in HC to an OD600 between 0.6 and 1.0. The culture was diluted to an OD600 of 0.4, and FM4-64 was added to a final concentration of 10 µM from a 10 mM stock in DMSO. Cells were labelled for 60 min with FM4-64, washed three times in fresh media by short and gentle centrifugation in a benchtop centrifuge, and then incubated for 60 min in media without FM4-64."
    ]
